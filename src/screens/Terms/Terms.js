...
const Terms = ({navigation}) => {
  ...
  return(
          ...
          <View style={styles.body}>
            <View style={styles.Radio_b_section}>
              <TouchableOpacity  onPress={()=>move_to_term_use()}>
                <Text style={styles.Radio_b_section_link_Reporting_conditions} >{t("Reportingconditions")}</Text>
              </TouchableOpacity>
            ...
            <View style={styles.Radio_b_section}>
                <TouchableOpacity onPress={()=> move_to_term_divor()}>
                  <Text style={styles.Radio_b_section_link_termuse}>{t("termuse")}</Text>
                </TouchableOpacity >
        ...
        <View style={styles.footer}>
            <LinearGradient style={styles.gradient_op} colors={['#A9333A', '#E1578A', '#FAE98F']}>
