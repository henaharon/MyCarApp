    ...
    return(
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.text}>{t("תנאי אישור באפליקציה")}</Text>
            ...
            <View style={styles.footer}>
                ...
                <LinearGradient style={styles.gradient_op} colors={['rgba(253,42,249,0.7)', 'rgba(253,42,211,0.52)']}>
